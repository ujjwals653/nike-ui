  ...
  return (
    <section id="about-us" className="flex justify-between items-center max-lg:flex-col gap-10 w-full max-container">
      <div className="flex flex-1 flex-col ">
        ...
        <h1 className='mt-10 font-palanquin text-[64px] max-sm:text-[20px] max-sm:leading-[82px] font-bold'>
          <span className='bg-white xl:whitespace-nowrap relative z-10 pr-5'>We Provide You</span>
          <span className='text-coral-red inline -mt-36'>Super Quality </span> Shoes
        </h1>
